            ...
            <div className=' max-w-6xl mx-auto'>
                ...
                <div className="flex flex-wrap-reverse">
                    <div className=' w-full lg:w-1/2 p-6 lg:p-8'>
                        ...
                        <button className='w-full lg:w-7/12 mt-3 bg-secondary text-white px-6 py-3 rounded-xl text-lg font-semibold border-2 border-secondary hover:bg-white hover:text-secondary hover:border-2 hover:border-secondary transition-all duration-300 md:px-8 md:py-4 md:text-xl'>Contactez-moi</button>
                    </div>
